...
<form action="{{route('users.update', $user->id)}}" method="post"  enctype="multipart/form-data" class="card col-5 mx-auto">
@csrf
@method('PATCH')
    ...
    <label for="data_di_nascita">Data di Nascita:</label>
      <input type="date" name="data_di_nascita" value="{{$user->data_di_nascita}}" placeholder="Inserisci la data di nascita">
