                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="data_di_nascita" type="date" class="form-control @error('data_di_nascita') is-invalid @enderror" name="data_di_nascita" value="{{ old('data_di_nascita') }}" required autocomplete="data_di_nascita" autofocus>
